...
import ReactNativeImg from '../../../images/reactnative2.png';
    ...
    <div className="row py-sm-5 py-2 px-2 mt-3">
        <div className="col-sm-4 text">
            <p>We recognize the increasing demand for mobile applications that deliver a seamless and consistent experience across both iOS and Android platforms. Our React Native Development Services are designed to harness the power of this versatile framework, enabling us to create dynamic, cross-platform mobile applications that cater to a wide range of industries and needs.
             ...
             <p>Our React Native development team comprises skilled and experienced professionals who are passionate about leveraging this technology to deliver exceptional solutions. We specialize in creating intuitive and feature-rich e-commerce mobile applications that cater to your specific business needs.
            </p>
          ...
          <div className="row">
            ...
            <div className="card shadow mb-4">
              ...
              <div className="card-body">
                <h5 className="card-title text-center">E-commerce Mobile Apps  </h5>
                <p className="card-text p-3 text">We specialize in creating intuitive and feature-rich e-commerce mobile applications that cater to your specific business needs. </p>  
              </div>
            </div>
            </div>
            ...
            <div className="col-sm-4">
            <div className="card shadow mb-4">
              <img src={Elearn} className="card-img-top img-fluid" alt="..." />
              <div className="card-body">
                <h5 className="card-title text-center">Education and E-Learning Apps  </h5>
                 <p className="card-text p-3 text">We develop interactive and educational mobile applications that facilitate learning and knowledge-sharing. 
                  </p>
            ...
            <div className="col-sm-4">
            <div className="card shadow mb-4">
              <img src={SocialMedia} className="card-img-top img-fluid " alt="..." />
              <div className="card-body">
                <h5 className="card-title text-center">Social Networking Apps   </h5>
                <p className="card-text p-3 text">Our expertise extends to developing engaging social networking apps that connect users and foster interaction. </p>
