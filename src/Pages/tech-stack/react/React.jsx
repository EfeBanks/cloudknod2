...
import Comp from '../../../images/reactComp.jpg';
    ...
    <div className="row py-5 px-2 mt-3">
        <div className="col-sm-4 text">
          ...
          <p>We are dedicated to delivering web applications that exceed your expectations. Our React Development Services combine cutting-edge technology with industry best practices to create powerful, scalable, and user-friendly solutions. Contact us today to discuss your project, and let's embark on a journey to transform your ideas into reality. 
            ...
            <p>Our commitment to your success extends beyond the initial development phase. We provide ongoing maintenance, updates, and support to keep your React-based web applications running smoothly and securely.</p>
          </div>
      </div>
    </div>
          ...
          <div className="row">
            ...
            <div className="card shadow mb-4">
              ...
              <div className="card-body">
                ...
                <p className="card-text p-3 text">We specialize in creating tailor-made web applications that align with your business goals and cater to your specific needs. From e-commerce platforms to social networking sites, we can build it all. </p>  
              </div>
            </div>
            </div>
            ...
            <div className="card shadow mb-4">
              ...
              <div className="card-body">
                <h5 className="card-title text-center">React Component Libraries  </h5>
                 <p className="card-text p-3 text">Our developers can create reusable component libraries that ensure consistency and speed up the development process for your projects. This accelerates time-to-market while maintaining a cohesive design. 
                  </p>
            ...
            <div className="card shadow mb-4">
              ...
              <div className="card-body">
                <h5 className="card-title text-center">Integration Services    </h5>
                <p className="card-text p-3 text">We seamlessly integrate React into your existing technology stack, ensuring that your web application operates smoothly with other systems and services. </p>
